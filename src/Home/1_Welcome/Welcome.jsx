        ...
        <div className="container">
          <div className="welcome_content">
            ...
            <p className="welcome_title">
              a living fantasy world created by players ⎯ a world that will go
              from a mobile game to the most free-to-play PC MMO RPG in history.
            </p>
            <div className="btn">
              <a className="btn_join_discord">Join Discord</a>
              <a
                onClick={() => setActivePage('collaborate')}
                className="btn_collaborate"
              >
                Collaborate
              </a>
            </div>
